        ...
        <div className="bg-Gray min-h-screen">
            <div className="md:hidden flex header items-center justify-center p-4">
                ...
                <div className="flex grow justify-center mr-6 items-center">
                    <Link href="/dashboard" className="text-gray-500 flex gap-4 items-center md:mb-4 mb-0 mr-2 md:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                             stroke="currentColor" className="w-6 h-6">
            ...
            <div className="flex bg-Gray relative">
                ...
                <div className="lg:w-1/2 lg:flex-grow-0 bg-Gray flex-grow p-4 rounded-l-xl rounded-r-xl bg-white mt-2 mr-2">
                    {children}
                </div>
            </div>
        </div>
