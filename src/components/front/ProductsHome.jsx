...
export async function ProductsHome() {
  ...
  return (
    <>
      <section className="p-6 lg:p-10 flex flex-col justify-center items-center">
        <div className="flex justify-center items-center gap-4 mb-6">
          <h2 className="mb-4 text-xl text-white">Last products</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {lastProducts &&
            lastProducts.slice(0, 3).map((product, index) => (
              <a
        ...
        <Link
          ...
          className="gap-2 text-white text-center underline whitespace-nowrap inline-flex mt-6"
        >
          See more
          <svg
