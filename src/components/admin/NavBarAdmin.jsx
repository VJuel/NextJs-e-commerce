        ...
        <aside
            ...
            <nav className="flex flex-col gap-2">
                ...
                <Link href="/dashboard/categories"
                      className={pathname.includes('/categories') ? activeLink : inactiveLink} onClick={handleNavActiveChange}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href="/dashboard/orders"
                      className={pathname.includes('/dashboard/orders') ? activeLink : inactiveLink} onClick={handleNavActiveChange}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href="/dashboard/admins"
                      className={pathname.includes('/dashboard/admins') ? activeLink : inactiveLink} onClick={handleNavActiveChange}>
                ...
                <Link href="/dashboard/settings"
                      className={pathname.includes('/dashboard/settings') ? activeLink : inactiveLink} onClick={handleNavActiveChange}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
