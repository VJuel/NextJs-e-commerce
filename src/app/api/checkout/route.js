...
export async function POST(req, res) {
    ...
    const {name, email, codePostal, city, streetAdress, country, cartProducts} = data;
    ...
    const orderDoc = await Order.create({
        line_items, name, email, city, codePostal, streetAdress, country, paid:false
    })
    ...
    return NextResponse.json({ data: session.url }, { status: 200 }, {message: "ok"})
